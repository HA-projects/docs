...
:::note
This guide is aimed for users running Home Assistant. Of course it is possible to run EVCC outside Home Assistant too, but as it has a very low footprint running EVCC as an
